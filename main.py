...
button = Button(rightFrame, text = "Check",fg = "Green", bd = 0, activebackground = "Blue", activeforeground = "White", command = checkPhish, relief = FLAT)
button.pack()

#created a label to display phishing site or not !
v = StringVar()
labelDisplay = Label(root, textvariable = v, pady = 20, bg = "#a1dbcd")
labelDisplay.pack()
