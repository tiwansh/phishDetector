''' Uses returnFinal.py 
	--------------------------------------------------MAY GIVE SERVICE UNAVAILABLE AFTER MULTIPLE REQUESTS. ---------------
	------------------------------------------------------WAIT SOME TIME TO INITIATE SCRIPT AGAIN. ----------------------------
'''
''' Autoamted script
...
import openpyxl
from returnFinal import isLegit
import time
